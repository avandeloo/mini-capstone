...
Order.create!([
  {user_id: 1, product_id: 1, quantity: 12, subtotal: nil, tax: nil, total: nil},
  {user_id: 1, product_id: 3, quantity: 13, subtotal: "845.0", tax: "76.05", total: "921.05"},
  {user_id: 1, product_id: 4, quantity: 2, subtotal: "100.0", tax: "9.0", total: "109.0"},
  {user_id: 1, product_id: 7, quantity: 7, subtotal: "280.0", tax: "25.2", total: "305.2"}
])
